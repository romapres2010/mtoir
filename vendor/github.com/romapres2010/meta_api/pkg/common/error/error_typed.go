...
var globalTypedErrorMessages = map[string]ErrorMessage{
	...
	ERR_JSON_MARSHAL_ERROR:                   {ERR_JSON_MARSHAL_ERROR, "Error marshal JSON: value=[%s]"},
	ERR_JSON_UNMARSHAL_ERROR:                 {ERR_JSON_UNMARSHAL_ERROR, "Error unmarshal JSON: value=[%s]"},
	ERR_XML_MARSHAL_ERROR:                    {ERR_XML_MARSHAL_ERROR, "Error marshal XMl: value=[%s]"},
	ERR_XML_UNMARSHAL_ERROR:                  {ERR_XML_UNMARSHAL_ERROR, "Error unmarshal XML: value=[%s]"},
	ERR_YAML_MARSHAL_ERROR:                   {ERR_YAML_MARSHAL_ERROR, "Error marshal YAML: value=[%s]"},
	ERR_YAML_UNMARSHAL_ERROR:                 {ERR_YAML_UNMARSHAL_ERROR, "Error unmarshal YAML: value=[%s]"},
	ERR_HTTP_LISTENER_CREATE_ERROR:           {ERR_HTTP_LISTENER_CREATE_ERROR, "Failed to create new TCP listener: ['network=['tcp']', 'address=[%s]']"},
	ERR_DB_CONNECTION_ERROR:                  {ERR_DB_CONNECTION_ERROR, "Failed to connect DB server: ['driver=[%s]', 'host=[%s]', 'port=[%s]', 'dbname=[%s]', 'sslmode=[%s]', 'user=[%s]']"},
	...
	ERR_DB_EXEC_ERROR:                        {ERR_DB_EXEC_ERROR, "Error NamedExec SQL statement: ['sqlID=[%v]', 'sql=[%s]', 'args=[%s]']"},
	ERR_DB_QUERYROWX_ERROR:                   {ERR_DB_QUERYROWX_ERROR, "Error QueryRow Struct Scan SQL statement: ['sqlID=[%v]', 'sql=[%s]', 'args=[%s]']"},
	ERR_DB_QUERYROW_ERROR:                    {ERR_DB_QUERYROW_ERROR, "Error QueryRow Scan SQL statement: ['sqlID=[%v]', 'sql=[%s]', 'args=[%s]']"},
	...
	ERR_WORKER_POOL_ADD_TASK_INCORRECT_STATE: {ERR_WORKER_POOL_ADD_TASK_INCORRECT_STATE, "Worker pool has incorrect state to add new task: ['current_state=[%v]', 'required_state=[%s]']"},
	ERR_WORKER_POOL_RUN_INCORRECT_STATE:      {ERR_WORKER_POOL_RUN_INCORRECT_STATE, "Worker pool has incorrect state to run: ['name=[%s]', 'current_state=[%v]', 'required_state=[%s]']"},
	ERR_WORKER_POOL_TASK_INCORRECT_STATE:     {ERR_WORKER_POOL_TASK_INCORRECT_STATE, "Worker pool - task has incorrect state to run: ['name=[%s]', 'current_state=[%v]', 'prev_state=[%v]', 'required_state=[%s]']"},
	...
	ERR_WORKER_POOL_TASK_ALREADY_LOCKED:      {ERR_WORKER_POOL_TASK_ALREADY_LOCKED, "Worker pool - task already locked for process: ['name=[%s]', 'current_state=[%v]', 'prev_state=[%v]']"},
	ERR_WORKER_POOL_ALREADY_LOCKED:           {ERR_WORKER_POOL_ALREADY_LOCKED, "Worker pool - already locked for process: ['name=[%s]', 'current_state=[%v]']"},
	...
	ERR_REFLECT_INCORRECT_TYPE:               {ERR_REFLECT_INCORRECT_TYPE, "Incorrect EntityMeta.ArgsFields.Type: ['entity=[%s]', 'field=[%s]', 'type=[%s]']"},
	ERR_CONTEXT_CLOSED_ERROR:                 {ERR_CONTEXT_CLOSED_ERROR, "Context was closed: ['message=[%s]', 'data=[%v]']"},
	ERR_EXPR_COMMON_ERROR:                    {ERR_EXPR_COMMON_ERROR, "Run expression error: ['errors=[%s]']"},
	ERR_VALIDATOR_COMMON_ERROR:               {ERR_VALIDATOR_COMMON_ERROR, "Validator error: ['errors=[%s]']"},
	ERR_VALIDATOR_FIELD_COMMON_ERROR:         {ERR_VALIDATOR_FIELD_COMMON_ERROR, "Entity '%s' field '%s'-  has validation error : [Namespace='%s', Tag='%s', Type='%s', Value='%v', Param='%s', 'mess='%s']"},
	...
	ERR_API_REFERENCE_DOES_NOT_EXISTS:        {ERR_API_REFERENCE_DOES_NOT_EXISTS, "Entity '%s' Reference '%s'['%s'] - Reference entity '%s' with key '%s'['%s']=['%s'] does not exists"},
	ERR_API_DUPLICATE_VALUE_ON_KEY:           {ERR_API_DUPLICATE_VALUE_ON_KEY, "Entity '%s' Key '%s' - duplicate value"},
	ERR_API_NO_DATA_FOUND_ON_KEY:             {ERR_API_NO_DATA_FOUND_ON_KEY, "Entity '%s' Key '%s' - no data found"},
	ERR_API_MISMATCH_VALUE_ON_KEY:            {ERR_API_MISMATCH_VALUE_ON_KEY, "Entity '%s' Key '%s' - mismatch value with Key '%s'"},
	ERR_API_NO_DATA_FOUND:                    {ERR_API_NO_DATA_FOUND, "Entity '%s' Key '%s'['%s']=['%s'] - no data found"},
}
