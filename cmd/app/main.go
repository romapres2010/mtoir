...
import (
	...
	_version "github.com/romapres2010/meta_api/pkg/common/version"

	_cfg "github.com/romapres2010/mtoir/pkg/app/config"
	daemon "github.com/romapres2010/mtoir/pkg/app/daemon"
)
...
var (
	...
	argsMetaEntityConfigFile string
	argsLogFile              string
	argsLogLevel             string
...
var flags = []cli.Flag{
	...
	cli.StringFlag{
		Name:        "meta_entity_cfg",
		Usage:       "Meta entity config file name",
		Required:    false,
		Destination: &argsMetaEntityConfigFile,
	},
	cli.StringFlag{
		Name:        "listen, l",
...
func main() {
	...
	app.Action = func(ctx *cli.Context) (err error) {
		...
		var globalCfg = &_cfg.Config{
			...
			ArgsMetaEntityConfigFile: argsMetaEntityConfigFile,
			...
			EnvMetaEntityConfigFile: os.Getenv(_cfg.ENV_APP_META_ENTITY_CONFIG_FILE),
